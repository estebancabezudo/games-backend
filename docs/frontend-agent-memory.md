...
- Repositorio frontend: `/home/esteban/Documents/games/frontend`; contiene el engine,
  el editor y sus pruebas.
- Repositorio backend: `/home/esteban/Documents/games/backend`. Todavía no aporta
  comportamiento al editor y no debe ampliarse sin una necesidad concreta.
- Checkout compartido de Plataforma: `/home/esteban/Documents/games/platform`.
...
- Los ZIP de revisión son untracked. `backend/scripts/package-games-sources.sh` sólo incluye
...
- ZIP base confirmado: `backend/scripts/games-sources-review-20260903-112500.zip`, 180 archivos,
  SHA-256 `078339438051ba15d6cc17088b77448a486764d41168e4da1298962a7143f3f2`.
- Comandos: desde `frontend/`, `npm test` y `npm run build`; desde `backend/`,
  `scripts/test-package-games-sources.sh`; en cada repositorio, `git diff --check`.
